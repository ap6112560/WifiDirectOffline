...
/**
 * The Class com.example.android.wifidirect.Conversation is a Java Bean class that represents a single chat
...
public class Conversation
{
	...
	{
		return DeviceListFragment.device.deviceName.equals(sender);
	}
